...
public class ItineraryFragment extends BeamListFragment<ItineraryFragmentPresenter,ItineraryBean>{

    @Override
    public BaseViewHolder<ItineraryBean> getViewHolder(ViewGroup parent, int viewType) {
